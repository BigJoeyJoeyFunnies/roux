...
local function getSpeed()
	...
	if lplr.Character then 
		...
		if SpeedDamageBoost and SpeedDamageBoost > 1 then 
			speed = speed + (8 * (SpeedDamageBoost - 0.9))
		end
...
runFunction(function()
	local function capeFunction(char, texture)
		...
		if texture:find(".webm") then 
			...
			decal = Instance.new("Decal", p)
                        decal.Texture = "rbxassetid://14476500723"
			decal.Face = "Back"
		end
		local msh = Instance.new("BlockMesh", p)
		msh.Scale = Vector3.new(9, 17.5, 0.5)
...
runFunction(function()
	local function capeFunction(char, texture)
		...
		if texture:find(".webm") then 
			...
			decal = Instance.new("Decal", p)
                        decal.Texture = "rbxassetid://14486838299"
			decal.Face = "Back"
		end
		local msh = Instance.new("BlockMesh", p)
		msh.Scale = Vector3.new(9, 17.5, 0.5)
...
runFunction(function()
	local function capeFunction(char, texture)
		...
		if texture:find(".webm") then 
			...
			decal = Instance.new("Decal", p)
                        decal.Texture = "rbxassetid://14476560392"
			decal.Face = "Back"
		end
		local msh = Instance.new("BlockMesh", p)
		msh.Scale = Vector3.new(9, 17.5, 0.5)
...
runFunction(function()
	local function capeFunction(char, texture)
		...
		if texture:find(".webm") then 
			...
			decal = Instance.new("Decal", p)
                        decal.Texture = "rbxassetid://14476511163"
			decal.Face = "Back"
		end
		local msh = Instance.new("BlockMesh", p)
		msh.Scale = Vector3.new(9, 17.5, 0.5)
...
runFunction(function()
    ...
    local InfiniteJump = GuiLibrary.ObjectsThatCanBeSaved.PurpulWindow.Api.CreateOptionsButton({
        Name = "InfiniteJump",
        Function = function(callback)
...
runService.Heartbeat:Connect(function()
    ...
    game:GetService("ReplicatedStorage").rbxts_include.node_modules["@rbxts"].net.out._NetManaged.ScytheDash:FireServer(unpack(args))
         ...
         Hovertext = "enable both for no flags"
      })
  end)
    ...
    ScytheDisabler = GuiLibrary.ObjectsThatCanBeSaved.ExploitWindow.Api.CreateOptionsButton({
        ...
        Function = function(callback)
            if callback then
                task.spawn(function()
                    while task.wait() do
                        if (not ScytheDisabler.Enabled) then return end
                        if getItemNear("scythe") and getItemNear("scythe").tool then
                            switchItem(getItemNear("scythe").tool)
                            if IsAlive(lplr) and lplr.Character.HandInvItem.Value == getItemNear("scythe").tool then
                                bedwars.ClientHandler:Get("ScytheSpin"):SendToServer({position = lplr.Character.HumanoidRootPart.Position})
                ...
                task.spawn(function()
                    while task.wait() do
                        if (not ScytheDisabler.Enabled) then return end
                        if entityLibrary.isAlive and lplr.Character:FindFirstChild("Head").Transparency == 1 then
                            for i = 1, 78 do
                                task.wait()
                                if (not ScytheDisabler.Enabled) then return end
                              --  lplr.Character:TranslateBy(lplr.Character:FindFirstChild("Humanoid").MoveDirection * 0.6)
                            end
                        end
                    end
                end)
...
runFunction(function()
	...
	local Packmode = {Value = "Normal"}
	Packs = GuiLibrary.ObjectsThatCanBeSaved.PurpulWindow.Api.CreateOptionsButton({
		Name = "TexturePacks",
		Function = function(callback)
			if callback then
	
						if Packmode.Value == "Novoline" then 
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/BigJoeyJoeyFunnies/roux/main/16x.lua"))()
						...
						elseif Packmode.Value == "256x" then 

loadstring(game:HttpGet("https://raw.githubusercontent.com/BigJoeyJoeyFunnies/roux/main/e.lua"))()

						elseif Packmode.Value == "PP" then 

loadstring(game:HttpGet("https://raw.githubusercontent.com/BigJoeyJoeyFunnies/roux/main/pp.lua"))()

                                                elseif Packmode.Value == "NovolinePink" then 

loadstring(game:HttpGet("https://raw.githubusercontent.com/StaryLOL/RobloxBedwarsTexturePack/main/PinkTX.lua"))()


						elseif Packmode.Value == "FirstPack" then 
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/BigJoeyJoeyFunnies/roux/main/32x.lua"))()
						...
						elseif Packmode.Value == "Barbie" then 

loadstring(game:HttpGet("https://raw.githubusercontent.com/BigJoeyJoeyFunnies/roux/main/Barbie.lua"))()

                                                 elseif Packmode.Value == "64x" then 
...
runFunction(function()
	...
	local CustomSkysMode = {Value = "Normal"}
	CustomSkys = GuiLibrary.ObjectsThatCanBeSaved.PurpulWindow.Api.CreateOptionsButton({
		Name = "CustomSkys",
		Function = function(callback)
			if callback then
	
						if CustomSkysMode.Value == "Anya" then 
...
runFunction(function()
    local BetterTPHighJump = {Enabled = false}
    local jumpHeight = 50
    local splitEnabled = false
    local slipTimes = 2  -- Default slip times

    local function PerformBetterHighJump()
        local character = game.Players.LocalPlayer.Character
        local humanoidRootPart = character and character:FindFirstChild("HumanoidRootPart")

        if humanoidRootPart then
            local jumpIncrement = jumpHeight / slipTimes
            for i = 1, slipTimes do
                humanoidRootPart.CFrame = CFrame.new(humanoidRootPart.Position + Vector3.new(0, jumpIncrement, 0))
                wait(0.1)
            end
        end
    end

    local BetterTPHighJumpButton = GuiLibrary.ObjectsThatCanBeSaved.PurpulWindow.Api.CreateOptionsButton({
        Name = "BetterTPHighJump",
        Function = function(callback)
            if callback then
                if splitEnabled then
           BetterTPHighJumpButton.ToggleButton(false)
                    PerformBetterHighJump()
          ...
          wait(0.6)
           BetterTPHighJumpButton.ToggleButton(false)
                    ...
                    if humanoidRootPart then
                        humanoidRootPart.CFrame = CFrame.new(humanoidRootPart.Position + Vector3.new(0, jumpHeight, 0))
                    end
                end
            end
        end,
        HoverText = "its just tphighjump with more customazation tbh"
    })

    local splitToggle = BetterTPHighJumpButton.CreateToggle({
        Name = "Split",
    ...
    local slipTimesSlider = BetterTPHighJumpButton.CreateSlider({
        Name = "SlipTimes",
        Min = 1,
        Max = 10,
        Default = slipTimes,
    ...
    local jumpHeightSlider = BetterTPHighJumpButton.CreateSlider({
        Name = "Height",
        Min = 1,
        Max = 500,
        Default = jumpHeight,
...
runFunction(function()
	...
	Night = GuiLibrary.ObjectsThatCanBeSaved.PurpulWindow.Api.CreateOptionsButton({
		Name = "Night",
		Function = function(callback)
			if callback then
...
runFunction(function()
	local Hsad = {Enabled = false}
	Hsad = GuiLibrary.ObjectsThatCanBeSaved.PurpulWindow.Api.CreateOptionsButton({
		Name = "Headless",
		Function = function(callback)
			if callback then
...
game.Lighting.Sky.SkyboxBk = "http://www.roblox.com/asset/?id=14377226407"
game.Lighting.Sky.SkyboxDn = "http://www.roblox.com/asset/?id=14377262378"
game.Lighting.Sky.SkyboxFt = "http://www.roblox.com/asset/?id=14377234229"
game.Lighting.Sky.SkyboxLf = "http://www.roblox.com/asset/?id=14377246718"
game.Lighting.Sky.SkyboxRt = "http://www.roblox.com/asset/?id=14377229625"
game.Lighting.Sky.SkyboxUp = "http://www.roblox.com/asset/?id=14377257222"
				pcall(function() workspace.Clouds:Destroy() end)
				local damagetab = debug.getupvalue(bedwars.DamageIndicator, 2)
				damagetab.strokeThickness = false
				damagetab.textSize = 32
				damagetab.blowUpDuration = 0
				damagetab.baseColor = Color3.fromRGB(170, 0, 170)
				damagetab.blowUpSize = 32
				damagetab.blowUpCompleteDuration = 0
				damagetab.anchoredDuration = 0
				debug.setconstant(bedwars.DamageIndicator, 83, Enum.Font.LuckiestGuy)
				...
				local colorcorrection = Instance.new("ColorCorrectionEffect")
				colorcorrection.TintColor = Color3.fromRGB(170, 0, 170)
				colorcorrection.Brightness = 0.05
				colorcorrection.Parent = lightingService
				debug.setconstant(require(lplr.PlayerScripts.TS.controllers.global.hotbar.ui.healthbar["hotbar-healthbar"]).HotbarHealthbar.render, 16, 12930502)
			end)
		...
		Valentines = function()
			task.spawn(function()
				...
				damagetab.textSize = 32
				damagetab.blowUpDuration = 0
				damagetab.baseColor = Color3.fromRGB(187, 79, 197)
				damagetab.blowUpSize = 32
				damagetab.blowUpCompleteDuration = 0
				damagetab.anchoredDuration = 0
				debug.setconstant(bedwars.DamageIndicator, 83, Enum.Font.LuckiestGuy)
				...
				local colorcorrection = Instance.new("ColorCorrectionEffect")
				colorcorrection.TintColor = Color3.fromRGB(187, 79, 197)
				colorcorrection.Brightness = 0.05
				colorcorrection.Parent = lightingService
				debug.setconstant(require(lplr.PlayerScripts.TS.controllers.global.hotbar.ui.healthbar["hotbar-healthbar"]).HotbarHealthbar.render, 16, 9175696)
			end)
		end
	}
	...
	GameThemeMode = GameTheme.CreateDropdown({
		Name = "Theme",
		Function = function() end,
		List = {"Old", "Winter", "Halloween", "Purp", "Valentines"}
	})
end)

...
--// Setting \\--
local range = 500 --The deafult range for the script
local rangeAddkeybind = Enum.KeyCode.None --Change the "E" to the keybind you want to use to add range.
local rangeSubtractkeybind = Enum.KeyCode.None --Change the "Q" to the keybind you want to use to subtract range.
local TogglePreciseRange = Enum.KeyCode.None --Change the "BackSlash" to the key you want to toggle precise range
local DoNotDisturb = true --If its on true, the script will notifiy you if your range has been changed. if its false then it doesnt notify.
local PreciseRange = true --Keep this off if you dont want your range value to have numbers that go into the 0.01's.
